...
<!-- HEADER -->
	...
	<a href="../dropzone/index.php"><input type="button" style="width:100%;border-width:3px;border-color:grey;height:32px;" value="ADD PHOTOS"></a>
	<a href=""><input type="button" style="width:100%;border-width:3px;border-color:grey;height:32px;" value="ADD MENU PHOTOS"></a>
